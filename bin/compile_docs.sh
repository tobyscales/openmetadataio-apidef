...
#echo "git push tobyscales@github.com:tobyscales/openmetadataio-apidef.git gh-pages"
#git push tobyscales@github.com:tobyscales/openmetadataio-apidef.git gh-pages
